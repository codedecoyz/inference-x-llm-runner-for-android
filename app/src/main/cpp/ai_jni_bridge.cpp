...
Java_com_mobilellama_ai_AIBridge_initLLM(
...
Java_com_mobilellama_ai_AIBridge_generateLLM(
    JNIEnv* env, jobject /*this*/,
...
JNIEXPORT void JNICALL
Java_com_mobilellama_ai_AIBridge_resetLLMContext(
    JNIEnv* /*env*/, jobject /*this*/)
{
    if (g_llm) {
        g_llm->reset_context();
...
JNIEXPORT void JNICALL
Java_com_mobilellama_ai_AIBridge_destroyLLM(
    JNIEnv* /*env*/, jobject /*this*/)
{
    g_llm.reset();
...
JNIEXPORT jboolean JNICALL
Java_com_mobilellama_ai_AIBridge_initHRM(
    JNIEnv* env, jobject /*this*/,
    jstring model_path,
    jint input_dim,
    jint h_dim,
...
Java_com_mobilellama_ai_AIBridge_inferHRM(
    JNIEnv* env, jobject /*this*/,
...
Java_com_mobilellama_ai_AIBridge_getHRMDiagnostics(
    JNIEnv* env, jobject /*this*/,
    jfloatArray input_arr)
{
...
JNIEXPORT void JNICALL
Java_com_mobilellama_ai_AIBridge_destroyHRM(
    JNIEnv* /*env*/, jobject /*this*/)
{
    g_hrm.reset();
...
Java_com_mobilellama_ai_AIBridge_getEngineStatus(
    JNIEnv* /*env*/, jobject /*this*/)
{
    int status = 0;
